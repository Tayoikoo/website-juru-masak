...
<head>
    ...
    <style>
        body{
            background-image: url(https://www.shutterstock.com/image-photo/white-wooden-table-covered-green-600nw-1916441990.jpg);
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1">
        <div class="container mt-3">
            ...
            <p class="text-center">Cari Resep Makanan yang anda inginkan</p>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="search" name="resep_makanan" class="form-control">
